...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(){
    const displayNames = []
    zooAnimals.forEach(function(habitat){
      displayNames.push(`name: ${habitat.animal_name}, scientific: ${habitat.scientific_name}`)
    })
    return displayNames
  }
  ...
  */
  ...
  function lowerCaseNames(){
    const modifiedNames = zooAnimals.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(){
    const endangeredAnimals = zooAnimals.filter(function(item){
